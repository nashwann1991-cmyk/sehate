        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center gap-2">
            <Link to="/" className="flex items-center gap-2">
              <div className="w-10 h-10 medical-gradient rounded-lg flex items-center justify-center text-white shadow-lg">
                <Activity size={24} />
              </div>
              <span className="text-xl font-bold text-medical-dark hidden sm:block">إجازتي المرضية</span>
            </Link>
          </div>
